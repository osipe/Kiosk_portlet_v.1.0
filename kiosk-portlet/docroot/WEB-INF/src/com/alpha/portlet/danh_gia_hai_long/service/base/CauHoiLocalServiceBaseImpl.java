...
import com.alpha.portlet.danh_gia_hai_long.service.CauHoiLocalService;
...
/**
 * Provides the base implementation for the cau hoi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.alpha.portlet.danh_gia_hai_long.service.impl.CauHoiLocalServiceImpl}.
 * </p>
 *
 * @author darkn
 ...
 * @generated
 */
public abstract class CauHoiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CauHoiLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.alpha.portlet.danh_gia_hai_long.service.CauHoiLocalServiceUtil} to access the cau hoi local service.
	 */
	...
	@Override
	public CauHoi addCauHoi(CauHoi cauHoi) throws SystemException {
		cauHoi.setNew(true);

		return cauHoiPersistence.update(cauHoi);
	}
	 ...
	 */
	@Override
	public CauHoi createCauHoi(long cauHoiId) {
		return cauHoiPersistence.create(cauHoiId);
	}
	...
	@Override
	public CauHoi deleteCauHoi(long cauHoiId)
		throws PortalException, SystemException {
		return cauHoiPersistence.remove(cauHoiId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CauHoi deleteCauHoi(CauHoi cauHoi) throws SystemException {
		return cauHoiPersistence.remove(cauHoi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CauHoi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cauHoiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cauHoiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cauHoiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return cauHoiPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public CauHoi fetchCauHoi(long cauHoiId) throws SystemException {
		return cauHoiPersistence.fetchByPrimaryKey(cauHoiId);
	}
	 ...
	 */
	@Override
	public CauHoi getCauHoi(long cauHoiId)
		throws PortalException, SystemException {
		return cauHoiPersistence.findByPrimaryKey(cauHoiId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cauHoiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CauHoi> getCauHois(int start, int end)
		throws SystemException {
		return cauHoiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCauHoisCount() throws SystemException {
		return cauHoiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CauHoi updateCauHoi(CauHoi cauHoi) throws SystemException {
		return cauHoiPersistence.update(cauHoi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.alpha.portlet.danh_gia_hai_long.model.CauHoi",
			cauHoiLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cauHoiPersistence.getDataSource();
	...
	private CauHoiLocalServiceClpInvoker _clpInvoker = new CauHoiLocalServiceClpInvoker();
}