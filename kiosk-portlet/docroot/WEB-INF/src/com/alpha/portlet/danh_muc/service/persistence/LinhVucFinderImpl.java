...
public class LinhVucFinderImpl extends BasePersistenceImpl<LinhVuc> implements LinhVucFinder {

	public static final String COUNT_BY_C_G_H_T_M_M = LinhVucFinder.class.getName() + ".countBy_C_G_H_T_M_M";
	public static final String FIND_BY_C_G_H_T_M_M = LinhVucFinder.class.getName() + ".findBy_C_G_H_T_M_M";
	...
	public int countBy_C_G_H_T_M_M(long companyId, long groupId, int hoatDong, String ten, String ma, String moTa, boolean andOperator) throws SystemException {
		...
		return countBy_C_G_H_T_M_M(companyId, groupId, hoatDong, new String[] { ten }, new String[] { ma }, new String[] { moTa }, andOperator);
	}

	public int countBy_C_G_H_T_M_M(long companyId, long groupId, int hoatDong, String[] tens, String[] mas, String[] moTas, boolean andOperator) throws SystemException {
	...
	public List<LinhVuc> findBy_C_G_H_T_M_M(long companyId, long groupId, int hoatDong, String ten, String ma, String moTa, boolean andOperator, int start, int end, OrderByComparator obc) throws SystemException {
		...
		return findBy_C_G_H_T_M_M(companyId, groupId, hoatDong, new String[] { ten }, new String[] { ma }, new String[] { moTa }, andOperator, start, end, obc);
	}

	public List<LinhVuc> findBy_C_G_H_T_M_M(long companyId, long groupId, int hoatDong, String[] tens, String[] mas, String[] moTas, boolean andOperator, int start, int end, OrderByComparator obc) throws SystemException {
		...
		try {
			...
			SQLQuery q = session.createSQLQuery(sql);
			q.addEntity("LinhVuc", LinhVucImpl.class);
			QueryPos qPos = QueryPos.getInstance(q);
			if(groupId > 0){
				qPos.add(groupId);
			}
			...
			qPos.add(mas, 2);
			qPos.add(moTas, 2);
			return (List<LinhVuc>) QueryUtil.list(q, getDialect(), start, end);
		} catch (Exception e) {
			throw new SystemException(e);
		} finally {
			closeSession(session);
