...
import com.alpha.portlet.dmdc.service.CauHinhLocalService;
...
/**
 * Provides the base implementation for the cau hinh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.alpha.portlet.dmdc.service.impl.CauHinhLocalServiceImpl}.
 * </p>
 *
 * @author darkn
 ...
 * @generated
 */
public abstract class CauHinhLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CauHinhLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.alpha.portlet.dmdc.service.CauHinhLocalServiceUtil} to access the cau hinh local service.
	 */
	...
	@Override
	public CauHinh addCauHinh(CauHinh cauHinh) throws SystemException {
		cauHinh.setNew(true);

		return cauHinhPersistence.update(cauHinh);
	}
	 ...
	 */
	@Override
	public CauHinh createCauHinh(long cauHinhId) {
		return cauHinhPersistence.create(cauHinhId);
	}
	...
	@Override
	public CauHinh deleteCauHinh(long cauHinhId)
		throws PortalException, SystemException {
		return cauHinhPersistence.remove(cauHinhId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CauHinh deleteCauHinh(CauHinh cauHinh) throws SystemException {
		return cauHinhPersistence.remove(cauHinh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CauHinh.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cauHinhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cauHinhPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return cauHinhPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cauHinhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return cauHinhPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public CauHinh fetchCauHinh(long cauHinhId) throws SystemException {
		return cauHinhPersistence.fetchByPrimaryKey(cauHinhId);
	}
	 ...
	 */
	@Override
	public CauHinh getCauHinh(long cauHinhId)
		throws PortalException, SystemException {
		return cauHinhPersistence.findByPrimaryKey(cauHinhId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cauHinhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CauHinh> getCauHinhs(int start, int end)
		throws SystemException {
		return cauHinhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCauHinhsCount() throws SystemException {
		return cauHinhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CauHinh updateCauHinh(CauHinh cauHinh) throws SystemException {
		return cauHinhPersistence.update(cauHinh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.alpha.portlet.dmdc.model.CauHinh",
			cauHinhLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cauHinhPersistence.getDataSource();
	...
	private CauHinhLocalServiceClpInvoker _clpInvoker = new CauHinhLocalServiceClpInvoker();
}