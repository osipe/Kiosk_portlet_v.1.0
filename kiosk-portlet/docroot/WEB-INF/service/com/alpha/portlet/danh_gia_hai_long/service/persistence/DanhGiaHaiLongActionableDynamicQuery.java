 ...
 * @generated
 */
public abstract class DanhGiaHaiLongActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DanhGiaHaiLongActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DanhGiaHaiLongLocalServiceUtil.getService());
		setClass(DanhGiaHaiLong.class);

		setClassLoader(com.alpha.portlet.danh_gia_hai_long.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("danhGiaHaiLongId");
	}
}