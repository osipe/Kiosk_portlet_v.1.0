...
/**
 * Provides the local service interface for TraLoi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author darkn
 * @see TraLoiLocalServiceUtil
...
public interface TraLoiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TraLoiLocalServiceUtil} to access the tra loi local service. Add custom service methods to {@link com.alpha.portlet.danh_gia_hai_long.service.impl.TraLoiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
