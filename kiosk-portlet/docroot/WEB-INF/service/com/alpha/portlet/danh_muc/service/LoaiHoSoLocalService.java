...
/**
 * Provides the local service interface for LoaiHoSo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author darkn
 * @see LoaiHoSoLocalServiceUtil
...
public interface LoaiHoSoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoaiHoSoLocalServiceUtil} to access the loai ho so local service. Add custom service methods to {@link com.alpha.portlet.danh_muc.service.impl.LoaiHoSoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
