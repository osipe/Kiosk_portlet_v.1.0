...
/**
 * Provides the remote service interface for LoaiHoSo. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author darkn
 * @see LoaiHoSoServiceUtil
...
public interface LoaiHoSoService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoaiHoSoServiceUtil} to access the loai ho so remote service. Add custom service methods to {@link com.alpha.portlet.danh_muc.service.impl.LoaiHoSoServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
