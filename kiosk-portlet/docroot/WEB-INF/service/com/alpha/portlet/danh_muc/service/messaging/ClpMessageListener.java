...
package com.alpha.portlet.danh_muc.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			LinhVucLocalServiceUtil.clearService();

			LinhVucServiceUtil.clearService();
			LoaiHoSoLocalServiceUtil.clearService();

			LoaiHoSoServiceUtil.clearService();
		}
	}
}