 ...
 * @generated
 */
public abstract class LinhVucActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public LinhVucActionableDynamicQuery() throws SystemException {
		setBaseLocalService(LinhVucLocalServiceUtil.getService());
		setClass(LinhVuc.class);

		setClassLoader(com.alpha.portlet.danh_muc.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("linhVucId");
	}
}